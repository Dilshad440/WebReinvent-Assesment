...
import '../../src/feature/todo_home/domain/model/res/todo_response.dart';
import '../constant/app_constant.dart';

mixin class SqfLiteService {
  Future<Database> _initializeDb({AddTodoReq? data}) async {
    ...
    return openDatabase(
      ...
      onCreate: (database, version) async {
        await database.execute(
          "CREATE TABLE ${AppConstant.tableName}(${_createColumns(data?.toJson() ?? AddTodoReq().toJson())})",
        );
      },
      version: 1,
    );
  ...
  Future<bool> insertIntoDb(AddTodoReq data) async {
